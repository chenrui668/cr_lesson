let data=[
    ...
    {value:'周杰伦的听妈妈的话，好好听！', time: 7, color:'blue', speed:1, fontSize:18},
    {value:'周杰伦的听妈妈的话，好好听！', time: 9, speed:1, fontSize:30},
]
...
class CanvasBarrage {
    ...
    renderBarrage() {
        // 根据时间来和弹幕要展示的时间作比较，判断是否展示弹幕
        // currentTime 是video自带的属性 获取视频播放的时间
...
class Barrage {
    ...
    init() {
        ...
        // 为了计算每个弹幕的宽度， 我们来创建一个元素p，然后计算p的宽度
...
// 设置video的play事件来调用canvasBarrage里的render
video.addEventListener('play', () => {
    // var addtime = canvasBarrage.video.currentTime;
    // $btn.addEventListener('click', function () {
    //     let addbarrage = {value: $txt.value, time: addtime, color: $color.value, speed: 1, fontSize: 22};
    //     data.push(addbarrage);
    // });
